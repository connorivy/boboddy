    ...
    savedExecution = await stepExecutionRepo.save(
      new TicketDescriptionEnrichmentStepExecutionEntity(
        ...
        new TicketDescriptionEnrichmentStepResultEntity(
          ...
          aiResult.whatHappened,
          aiResult.datadogQueryTerms,
          aiResult.datadogTimeRange,
          aiResult.keyIdentifiers,
          aiResult.exactEventTimes,
          aiResult.codeUnitsInvolved,
          aiResult.databaseFindings,
          aiResult.logFindings,
          aiResult.datadogSessionFindings,
          aiResult.investigationGaps,
          aiResult.recommendedNextQueries,
          aiResult.confidenceLevel,
          { ...aiResult.rawResultJson, rawResponse: aiResult.rawResponse },
          "complete",
          "local-codex",
