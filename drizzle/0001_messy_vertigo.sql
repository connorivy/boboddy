...
CREATE TABLE "pipeline_runs" (
	...
	"halt_reason" text,
	"pipeline_type" text DEFAULT 'default' NOT NULL,
...
ALTER TABLE "ticket_duplicate_candidates" ADD CONSTRAINT "ticket_duplicate_candidates_step_execution_id_ticket_step_executions_tph_id_fk" FOREIGN KEY ("step_execution_id") REFERENCES "public"."ticket_step_executions_tph"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "pipeline_runs_ticket_started_at_unique" ON "pipeline_runs" USING btree ("ticket_id","started_at");--> statement-breakpoint
CREATE UNIQUE INDEX "ticket_duplicate_candidates_pair_unique" ON "ticket_duplicate_candidates" USING btree ("step_execution_id","candidate_ticket_id");--> statement-breakpoint
...
CREATE INDEX "ticket_step_executions_pipeline_run_id_idx" ON "ticket_step_executions" USING btree ("pipeline_run_id");--> statement-breakpoint
CREATE UNIQUE INDEX "ticket_step_executions_tph_idempotency_key_unique" ON "ticket_step_executions_tph" USING btree ("idempotency_key");--> statement-breakpoint
CREATE INDEX "ticket_step_executions_tph_pipeline_run_id_idx" ON "ticket_step_executions_tph" USING btree ("pipeline_run_id");
